...
const FeedPage = () => {
  return (
    <div className="flex flex-col md:flex-row min-h-screen p-4 bg-base-300">
        ...
        <div className="bg-white shadow-lg rounded-lg p-6">
          ...
          <div className="flex items-center space-x-4 mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">Software Developer at Newco</p>
            </div>
          </div>
          {/* Posting as */}
        ...
        <div className="mt-6">
          ...
          <ul className="space-y-2">
            <li className="flex items-center space-x-2">
              <div className="avatar">
                <div className="w-8 rounded-full bg-gray-100 flex items-center justify-center">
      ...
      <div className="w-full md:w-1/2 p-4">
        <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  ...
                  <span className="text-xs text-gray-500">Jobs in Tech</span>
                </div>
              </div>
              <span className="text-xs text-gray-500">2h</span>
            </div>
            <p className="mt-4 text-gray-700">Tig welder job</p>
          ...
          <div className="bg-white shadow-lg rounded-lg p-6">
            ...
            <p className="mt-4 text-gray-700">Hello everyone, I have been applying to jobs...</p>
            <div className="flex items-center space-x-4 mt-4">
              <button className="flex items-center space-x-1 text-gray-500 hover:text-purple-500">
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 15l7-7 7 7" />
        ...
        <div className="bg-white shadow-lg rounded-lg p-6">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gray-100 p-4 rounded-lg">
              ...
              <p className="text-sm text-gray-500">A community for Product Managers to learn, create, and connect.</p>
              <button className="btn btn-primary mt-2">Preview</button>
            </div>
            <div className="bg-gray-100 p-4 rounded-lg">
              <h4 className="text-md font-semibold">Black in Tech</h4>
              <p className="text-sm text-gray-500">A safe space to discuss all things related to technology & being black.</p>
              <button className="btn btn-primary mt-2">Preview</button>
            </div>
