...
const FeedPage = () => {
  const { data, isLoading: isLoadingFeeds, error } = usePostFeeds();
  ...
  const [posts, setPosts] = useState<PostInterface[]>(data?.data || []);
  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen p-4 bg-gradient-to-r from-blue-50 via-purple-50 to-blue-100">
      ...
      <div className="w-full md:w-1/2 p-4">
        ...
        {/* Loading Spinner for Submitting Post or Loading Feeds */}
        {/* {(isSubmitting || isLoadingFeeds) && <LoadingSpinner />} */}
